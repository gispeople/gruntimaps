...
{
    public class LocalMapLayerUpdateSubscriptionClient : IMapLayerUpdateSubscriptionClient
    {
        private readonly ILogger _logger;
        private bool _registered;

        public LocalMapLayerUpdateSubscriptionClient(ILogger logger)
        {
        ...
        {
            _logger.LogInformation("RegisterOnMessageHandlerAndReceiveMessages called");
            if (!_registered)
            {
